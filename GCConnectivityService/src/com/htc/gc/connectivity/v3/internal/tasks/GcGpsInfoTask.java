	...
	public void execute() throws Exception {
		...
		if (mAction == ACTION_SET_GPS_INFO_LTEVENT) {
			...
			if (bootResult == Common.ERROR_SUCCESS)
			{
				...
				future = mExecutor.submit(new GcBleWriteCallable(mGcBleTransceiver, mBluetoothDevice, GcBleGattAttributes.GcV2CommandEnum.SET_GPS_DATA_REQUEST, gpsInfoArray));
				result = future.get();
