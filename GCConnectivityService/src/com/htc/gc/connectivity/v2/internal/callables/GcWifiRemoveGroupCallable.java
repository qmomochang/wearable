...
public class GcWifiRemoveGroupCallable implements Callable<Integer> {

	private final static String TAG = "GcWifiRemoveGroupCallable";
	...
	private GcWifiTransceiverListener mGcWifiTransceiverListener = new GcWifiTransceiverListener() {
		...
		public void onWifiDirectGroupRemoved() {
			...
			Log.d(TAG, "[MGCC] onWifiDirectGroupRemoved!!");
	...
	public GcWifiRemoveGroupCallable(GcWifiTransceiver transceiver) {
	...
	public Integer call() throws Exception {
		...
		if (mGcWifiTransceiver.removeGroup()) {
