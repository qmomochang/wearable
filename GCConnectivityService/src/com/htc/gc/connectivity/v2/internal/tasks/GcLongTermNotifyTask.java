...
public class GcLongTermNotifyTask extends GcConnectivityTask {
	...
	public void execute() throws Exception {
		...
		if (mAction == ACTION_SET_LTNOTIFY) {
			...
			futureA = mExecutor.submit(new GcBleSetNotificationCallable(mGcBleTransceiver, mBluetoothDevice, GcBleGattAttributes.GC_SHORT_COMMAND_NOTIFY, true));
			futureB = mExecutor.submit(new GcBleSetNotificationCallable(mGcBleTransceiver, mBluetoothDevice, GcBleGattAttributes.GC_LONG_COMMAND_NOTIFY, true));
			...
			futureA = mExecutor.submit(new GcBleSetNotificationCallable(mGcBleTransceiver, mBluetoothDevice, GcBleGattAttributes.GC_SHORT_COMMAND_NOTIFY, false));
			futureB = mExecutor.submit(new GcBleSetNotificationCallable(mGcBleTransceiver, mBluetoothDevice, GcBleGattAttributes.GC_LONG_COMMAND_NOTIFY, false));
