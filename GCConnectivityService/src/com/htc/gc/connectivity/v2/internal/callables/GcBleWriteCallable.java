...
public class GcBleWriteCallable implements Callable<BluetoothGattCharacteristic> {
	...
	public GcBleWriteCallable(GcBleTransceiver transceiver, BluetoothDevice device, String uuidString, byte[] writeData) {
	...
	public BluetoothGattCharacteristic call() throws Exception {
		...
		do {
			...
			int writeSize = mGcBleTransceiver.writeGcCommand(mBluetoothDevice, mUuidString, mWriteData, 0);
			if (writeSize < 0) {
