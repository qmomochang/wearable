...
public class QueryFullHDThumbnailTask extends BackgroundDownloadFragmentTask {
	private static final int COMMAND_ID = Protocol.FILE_GET_JPEG_FULLHD;

	private final IMediaItem mMediaItem;

	public QueryFullHDThumbnailTask(IMediaItem mediaItem, DataCallback callback) {
