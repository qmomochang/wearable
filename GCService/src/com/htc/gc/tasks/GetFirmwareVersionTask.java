...
import com.htc.gc.interfaces.IDeviceController.FirmwareVersionCallback;
import com.htc.gc.internal.GCTask;
import com.htc.gc.internal.Protocol;

public class GetFirmwareVersionTask extends GCTask {
	private static final int COMMAND_ID = Protocol.SYS_GET_FW_VERSION;
	
	private final IDeviceController mThat;
	private final FirmwareVersionCallback mCallback;
		
	public GetFirmwareVersionTask(IDeviceController that, FirmwareVersionCallback callback) {
		mThat = that;
		mCallback = callback;
	}
