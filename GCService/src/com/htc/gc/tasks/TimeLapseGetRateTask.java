...
import com.htc.gc.interfaces.IStillCapturer.TimeLapseRateCallback;
import com.htc.gc.internal.GCTask;
import com.htc.gc.internal.Protocol;

public class TimeLapseGetRateTask extends GCTask {
	private static final int COMMAND_ID = Protocol.CAPTURE_GET_TIMELAPSE_RATE;
	
	private final IStillCapturer mThat;
	private final TimeLapseRateCallback mCallback;
	
	public TimeLapseGetRateTask(IStillCapturer that, TimeLapseRateCallback callback) {
		mThat = that;
		mCallback = callback;
	}
